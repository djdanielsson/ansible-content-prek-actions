...
Most hooks use [ansible-dev-tools==26.4.1](https://github.com/ansible/ansible-dev-tools)
...
Most hooks pin `ansible-dev-tools==26.4.1` for a known-good set of tool
